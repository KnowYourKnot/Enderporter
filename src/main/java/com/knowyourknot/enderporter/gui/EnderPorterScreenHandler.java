...
public class EnderPorterScreenHandler extends ScreenHandler {
    ...
    public EnderPorterScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, new SimpleInventory(12), new ArrayPropertyDelegate(3));
    }

    public EnderPorterScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate propertyDelegate) {
        ...
        Item[] validTeleportItems = { EnderPorter.STABLE_PEARL, EnderPorter.PORTABLE_PORTER, EnderPorter.DEBUG_ITEM };
